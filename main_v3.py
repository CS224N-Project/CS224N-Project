...
class RNNModel(Model):
    ...
    def add_prediction_op(self):
        ...
        h1_last = tf.zeros(shape = (batch_size, hidden_size),
                           dtype = tf.float32)
        h2_last = tf.zeros(shape = (batch_size, hidden_size),
                           dtype = tf.float32)
        ...
        h_t = tf.concat(concat_dim = 1, values = [h1_last, h2_last])
...
## Aly readin 
train = "/Users/alysonkane/Desktop/Classes/4 - Winter 2017/cs224n/project/beer/reviews.aspect1.small.train.txt.gz"
dev = "/Users/alysonkane/Desktop/Classes/4 - Winter 2017/cs224n/project/beer/reviews.aspect1.small.heldout.txt.gz"
